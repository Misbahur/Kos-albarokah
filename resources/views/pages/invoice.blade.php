			...
			<td class="bg-grey" style="width:25%;height:25%;line-height:0;">
				<div class="invoice-box">
					<table>
						...
						<tr>
							<td>Tanggal Sewa : {{ $tanggalsewa }}</td>
						</tr>
						...
						<tr>
							<td colspan="3" style="padding-bottom: 2px; padding-top: 30px; text-align: center; color:#A9A9A9">Tgl Cetak : {{ now() }}</td>
						</tr>
					</table>
				</div>
