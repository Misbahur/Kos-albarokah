    ...
    <div class="py-8">
        <div class="max-w-7xl flex justify-between mx-auto sm:px-6 lg:px-8">
            <div class="w-6/8 pr-2">
                ...
                <div class="bg-white shadow-md pt-16 gap-20 px-10 flex items-center justify-between">
                    <div>
                       <img class="object-fill h-28 w-96" src="{{ asset('bank/bni.png') }}" alt="">
                    </div>
                    <div>
                        <img class="object-fill h-28 w-96" src="{{ asset('bank/bca.jpg') }}" alt="">
                    </div>
                </div>
                 <div class="bg-white shadow-md pt-16 gap-20 px-10 flex items-center justify-between">
                    <div>
                       <img class="object-fill h-28 w-96" src="{{ asset('bank/mandiri.png') }}" alt="">
                    </div>
                    <div>
                        <img class="object-fill h-28 w-96" src="{{ asset('bank/bri.jpg') }}" alt="">
                    </div>
                </div>
                <div class="bg-white shadow-md pt-16 gap-20 px-10 flex items-center justify-between">
                    <div>
                       <img class="object-fill h-28 w-96" src="{{ asset('bank/gopay.jpg') }}" alt="">
                    </div>
                    <div>
                        <img class="object-fill h-28 w-96" src="{{ asset('bank/dana.jpg') }}" alt="">
                    </div>
                </div>
                <div class="flex items-center py-6 px-8 bg-white shadow-md pt-16 justify-end">
                    <a class="py-2 px-8 bg-blue-100 text-blue-800 rounded-md" href="">Lanjut Ke Pembayaran</a>
                </div>
        </div>
        <div class="w-2/8">
