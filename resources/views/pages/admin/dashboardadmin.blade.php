                    ...
                    <ul class="list-none">
                            ...
                            <div class="flex justify-between p-3 pt-4 bg-blue-500 shadow-sm">
                                <div>
                                    <div class="text-xl font-bold text-white">Rp.
                                        {{ number_format($pemasukan_mingguan) }}</div>
                                    <div class="pt-6 px-2 text-sm font-semibold text-gray-200">Pemasukan Minggu ini
                                    </div>
                                </div>
                        ...
                        <li class="py-2">
                            <div class="flex justify-between p-3 pt-4 bg-blue-500 shadow-sm">
                                <div>
                                    <div class="text-xl font-bold text-white">Rp.
                                        {{ number_format($pemasukan_bulanan) }}</div>
                        ...
                        <li class="py-2">
                            <div class="flex justify-between p-3 pt-4 bg-blue-500 shadow-sm">
                                <div>
                                    <div class="text-xl font-bold text-white">Rp.
                                        {{ number_format($pemasukan_tahunan) }}</div>
                        ...
                        <div class="p-4 bg-gray-200">
                            ...
                            <div class="py-2 px-1">
                                ...
                                <ul role="list" class="grid grid-cols-1 gap-6 sm:grid-cols-1 lg:grid-cols-1">
                                    @foreach ($transaksi_last_week as $last)
                                                ...
                                                <div class="flex-1 truncate">
                                                    <div class="flex items-center space-x-3">
                                                        <h3 class="text-gray-900 text-sm font-medium truncate">
                                                            {{ $last->kamar->cabang->nama }}
                                                        </h3>
                                                    </div>
                                                    <p class="mt-1 text-gray-500 text-sm truncate">Kamar
                                                        {{ $last->kamar->kode }}
                                                    </p>
                                                </div>
                                            </div>
                                                ...
                                                <div class="-mt-px flex">
                                                    <div class="flex-1 w-0 flex">
                                                        <a href="#"
                                                            ...
                                                            <span
                                                                class="ml-3">{{ $last->kamar->cabang->kategori }}</span>
                                                        </a>
                                                    </div>
                                                    <div class="-ml-px w-0 flex-1 flex">
                                                        <a href="#"
                                                            ...
                                                            <!-- Heroicon name: solid/phone -->
                                                            <span class="ml-3">Rp.
                                                                {{ number_format($last->kamar->harga) }}</span>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="py-10 px-4 sm:px-6 lg:px-8">
                        <div class="sm:flex sm:items-center">
                            <div class="sm:flex-auto">
                                ...
                                <p class="mt-2 text-sm text-gray-700">Berikut ini Adalah Data Kamar yang telah dihuni
                                    beserta identitas penghuni Kos Al-Barokah.</p>
                            </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-300">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col"
                                            class="relative py-3.5 text-center text-sm font-semibold text-gray-900">
                                            Select
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($penghuni_kos as $key => $row)
                                        <tr>
                                            ...
                                            <td class="hidden px-3 py-3.5 text-sm text-gray-500 lg:table-cell">
                                                {{ $row->kamar->cabang->nama }} - {{ $row->kamar->kode }}</td>
                                            <td class="hidden px-3 py-3.5 text-sm text-gray-500 lg:table-cell">Bulan
                                            </td>
                                            <td class="hidden px-3 py-3.5 text-sm text-gray-500 lg:table-cell">Rp.
                                            ...
                                            <td class="px-3 py-3.5 text-sm text-gray-500">
                                                ...
                                                @else
                                                    <div class="hidden sm:block">Belum Lunas</div>
                                                @endif
                                            </td>
                                            <td
                                                ...
                                                <button type="button"
                                                    class="inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-30">Select<span
                                                        class="sr-only">{{ $row->user->name }}</span></button>
                                            </td>
                                        </tr>
                                    @endforeach
                                    <!-- More plans... -->
