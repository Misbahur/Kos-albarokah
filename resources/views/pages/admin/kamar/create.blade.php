                    ...
                    <div>
                        ...
                        <div class="sm:items-start sm:pt-5">
                            ...
                            <x-input-form>
                                ...
                                <x-slot name="input">
                                    <input type="text" name="kode" id="kode" autocomplete="kode"
                        ...
                        <div class="sm:items-start sm:pt-5">
                            ...
                            <x-input-form>
                                ...
                                <x-slot name="input">
                                    <input type="number" name="panjang" id="panjang" autocomplete="panjang"
                        ...
                        <div class="sm:items-start sm:pt-5">
                            ...
                            <x-input-form>
                                ...
                                <x-slot name="input">
                                    <input type="number" name="lebar" id="lebar" autocomplete="lebar"
                        ...
                        <div class="sm:items-start sm:pt-5">
                            ...
                            <x-input-form>
                                ...
                                <x-slot name="input">
                                    <input type="number" name="harga" id="harga" autocomplete="harga"
                                        class="max-w-lg w-full shadow-sm focus:ring-indigo-500 pl-10 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-full" />
                                </x-slot>
                            </x-input-form>
                        </div>
